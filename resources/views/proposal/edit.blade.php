                                                      ...
                                                      <tfoot>
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                <input readonly type="text" id="total_amount" name="total_amount" value="{{number_format($proposal->total_amount,2)}}" style="border:none;float:right;"><br>
                                                                <label for="dis_val">Discount:</label>
                                                                <input readonly type="text" id="dis_val" name="dis_val" value="{{number_format($proposal->discount,2)}}" style="border:none;float:right;"><br>
                                                                <label for="total_tax">Total Tax:</label>
                                                                <input readonly type="text" name="total_tax" id="total_tax" value="{{number_format($proposal->total_tax_amount,2)}}" style="border:none;float:right;"><br>
                                                                <label for="grand_total">Total:</label>
                                                               <input readonly type="text" id="grand_total" name="grand_total" value="{{number_format($proposal->grand_total,2)}}" style="border:none;float:right;">
                                                            </th>
                                                            <th colspan="5">
