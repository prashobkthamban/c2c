                                                      ...
                                                      <tfoot>
                                                        <tr>
                                                            ...
                                                            <th>
                                                                ...
                                                                <input type="text" id="total_amount" name="total_amount" value="{{$proposal->total_amount}}" style="border:none;width: 82px;text-align: right;"><br>
                                                                ...
                                                                <input type="text" name="total_tax" id="total_tax" value="{{$proposal->total_tax_amount}}" style="border:none;text-align: right;width: 100px;"><br>
                                                                <label for="grand_total">Grand Total:</label>
                                                               <input type="text" id="grand_total" name="grand_total" value="{{$proposal->grand_total}}" style="border:none;width: 82px;text-align: right;">
                                                            </th>
                                                            <th colspan="5">
