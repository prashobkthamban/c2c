  ...
  <div class="breadcrumb">
                                ...
                                <table id="zero_configuration_table" class="display table table-striped table-bordered" style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="text-primary mr-2 view_modal" data-toggle="modal" data-target="#view" id="view_{{$row->id}}" onClick="replyModal({{$row->id}})">
                                            ...
                                            <a href="#" class="text-primary mr-2 reply_modal" data-toggle="modal" data-target="#reply" onClick="replyModal({{$row->id}})">
            ...
            <div class="modal fade" id="view" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle-2" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalCenterTitle-2">View Notification <span id="notify_title"></span></h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $( '.notification_form' ).on( 'submit', function(e) {
          ...
          $.ajax({
            type: "POST",
            url: '{{ URL::route("addNotification") }}', // This is the url we gave in the route
