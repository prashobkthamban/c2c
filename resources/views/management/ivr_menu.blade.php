                            ...
                            <tbody>   
                                ...
                                <tr id="row_{{ $listOne->id }}">
                                    ...
                                    <td>
                                        ...
                                        <a href="javascript:void(0)" onClick="deleteItem({{$listOne->id}}, 'ivr_menu')" class="text-danger mr-2">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-2 form-group mb-3"> 
                            {!! Form::hidden('id', null, ['class' => 'form-control', 'id' => 'ivr_menu_id']) !!}
     ...
     $(document).ready(function() {
        ...
        $("input:file").change(function (){
            ...
            if($.inArray(ext, ['gsm', 'wav']) == -1) {
                alert('Please select gsm or wav files.');
                $("input:file").val('');
                return false;
            } else {
