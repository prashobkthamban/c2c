(function($) {
  ...
  $(function() {
    ...
    if ($("#marketingOverview").length) {
      ...
      loadCallDataGraph();
      setInterval(loadCallDataGraph, 60*1000);
      function loadCallDataGraph() {
        $.ajax({
          type: "GET",
          url: 'graph_todays_calls',
          success: function(result) {
            console.log(result);
            var marketingOverview = new Chart(marketingOverviewChart, {
                type: 'bar',
                data: result.marketingOverviewData,
    ...
    if ($("#doughnutChart").length) {
      ...
      loadCallDataChart();
      setInterval(loadCallDataChart, 60*1000);
      function loadCallDataChart() {
        $.ajax({
          type: "GET",
          url: 'chart_todays_calls',
          success: function(result) {
            console.log(result);
